                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <select name="category" 
                            ...
                            @endforeach
                            <option value="molen" {{ old('category') == 'molen' ? 'selected' : '' }}>Molen</option>
                            <option value="soes" {{ old('category') == 'soes' ? 'selected' : '' }}>Soes</option>
                            <option value="onde-onde" {{ old('category') == 'onde-onde' ? 'selected' : '' }}>Onde-onde</option>
                            <option value="pastel" {{ old('category') == 'pastel' ? 'selected' : '' }}>Pastel</option>
                        </select>
                        @error('category')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
